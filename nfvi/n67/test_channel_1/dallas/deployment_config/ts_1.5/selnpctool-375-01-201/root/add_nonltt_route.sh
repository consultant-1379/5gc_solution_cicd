...
ip link add link p3p2_tap name vlan0154  type vlan id 154 || true
ip link add link p3p2_tap name vlan0153  type vlan id 153 || true

ip add add 11.100.2.5/24 dev vlan0141 || true
ip add add 11.100.30.5/24 dev vlan0154 || true
ip add add 2a00:11.100.30::1/64 dev vlan0154 || true
ip add add 11.100.29.5/24 dev vlan0153 || true
ip add add 11.100.5.5/24 dev vlan0144 || true
ip add add 2a00:11.100.5::1/64 dev vlan0144 || true
ip add add 11.100.4.5/24 dev vlan0143 || true
...
#ifconfig lo:00 8.8.1.5/32 up || true
...
#### GnodeB N2
route add -net 6.192.32.0/19 gw 11.20.1.102
route add -net 6.192.64.0/19 gw 11.20.1.103
...
route add -net 8.140.64.0/19 gw 11.20.1.103
