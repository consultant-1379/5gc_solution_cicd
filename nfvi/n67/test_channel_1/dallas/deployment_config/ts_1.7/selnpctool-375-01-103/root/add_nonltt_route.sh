...
#ip add add 11.20.1.103/19 dev vlan0051
...
route add -host 10.132.128.136 gw 11.20.1.202 || true
route add -host 10.132.144.136 gw 11.20.1.202 || true
route add -net 10.132.128.96/29 gw 11.20.1.202 || true
route add -net 10.132.144.96/29 gw 11.20.1.202 || true
