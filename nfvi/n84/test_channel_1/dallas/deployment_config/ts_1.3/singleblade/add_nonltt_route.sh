...
ip link add link p1p1_tap name vlan0102  type vlan id 102
ip link add link p1p1_tap name vlan0104  type vlan id 104
ip link add link p2p1_tap name vlan0105  type vlan id 105
ip add add 11.0.5.2/24 dev vlan0105
ip add add 11.0.4.2/24 dev vlan0104
ip add add 11.0.2.2/24 dev vlan0102
