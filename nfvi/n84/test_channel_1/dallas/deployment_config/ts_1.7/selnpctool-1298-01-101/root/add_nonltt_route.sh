...
ip add add 11.20.1.101/19 dev vlan0051
...
ip add add 11.0.5.3/24 dev vlan0105
ip add add 11.0.4.3/24 dev vlan0104
ip add add 11.0.2.3/24 dev vlan0102
...
# amf n2 AND mme s1-mme
ip route add 10.131.128.0/24  via 11.0.4.254 || true
ip route add 10.131.144.0/24  via 11.0.4.254 || true
