...
ip add add 172.30.49.103/24 dev vlan01207 || true
ip add add 172.30.48.103/24 dev vlan01204 || true
ip add add 172.30.50.103/24 dev vlan01224 || true
ip add add 172.30.64.103/24 dev vlan01205 || true
ip add add 172.30.66.103/24 dev vlan01225 || true
ip add add 172.30.16.103/24 dev vlan01202 || true

ip add add fdac:30:64::103/64 dev vlan01205 || true
ip add add fdac:30:66::103/64 dev vlan01225 || true
