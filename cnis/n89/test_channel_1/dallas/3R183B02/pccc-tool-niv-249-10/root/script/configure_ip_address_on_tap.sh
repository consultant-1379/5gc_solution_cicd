...
ip add add 172.30.49.104/24 dev vlan01207 || true
ip add add 172.30.48.104/24 dev vlan01204 || true
ip add add 172.30.50.104/24 dev vlan01224 || true
ip add add 172.30.64.104/24 dev vlan01205 || true
ip add add 172.30.66.104/24 dev vlan01225 || true
ip add add 172.30.16.104/24 dev vlan01202 || true

ip add add fdac:30:64::104/64 dev vlan01205 || true
ip add add fdac:30:66::104/64 dev vlan01225 || true
