...
ip add add 172.30.49.106/24 dev vlan01207 || true
ip add add 172.30.48.106/24 dev vlan01204 || true
ip add add 172.30.50.106/24 dev vlan01224 || true
ip add add 172.30.64.106/24 dev vlan01205 || true
ip add add 172.30.66.106/24 dev vlan01225 || true
ip add add 172.30.16.106/24 dev vlan01202 || true

ip add add fdac:30:64::106/64 dev vlan01205 || true
ip add add fdac:30:66::106/64 dev vlan01225 || true
