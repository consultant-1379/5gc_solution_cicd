...
ip add add 11.100.2.3/24 dev vlan0141 || true
ip add add 11.100.30.3/24 dev vlan0154 || true
#ip add add 2a00:11.100.30::2/64 dev vlan0154 || true
ip add add 11.100.29.3/24 dev vlan0153 || true
ip add add 11.100.5.3/24 dev vlan0144 || true
#ip add add 2a00:11.100.5::2/64 dev vlan0144 || true
ip add add 11.100.4.3/24 dev vlan0143 || true
